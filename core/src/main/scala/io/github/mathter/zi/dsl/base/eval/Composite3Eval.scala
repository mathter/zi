...
private class Composite3Eval[T, T0, T1, T2, T3](val t: Eval[T], val t0: Eval[T0], val t1: Eval[T1], val t2: Eval[T2], val t3: Eval[T3])(implicit dsl: Dsl) extends Composite3[T, T0, T1, T2, T3] {
